...
const certs = [
  { id: 'iso-9001', logo: <img src={iso9001Logo} alt="ISO 9001:2015" className="w-20 h-20 object-contain" />, name: 'ISO 9001:2015', description: 'Quality Management System' },
  { id: 'iso-14001', logo: <img src={iso1logo} alt="ISO 14001:2015" className="w-20 h-20 object-contain" />, name: 'ISO 14001:2015', description: 'Environmental Management System' },
  {
    id: 'sedex',
    logo: <img src={sedex} alt="Sedex" className="w-20 h-20 object-contain" />,
    name: 'Sedex',
    description: 'Ethical Trade Member',
  },
  { id: 'grs', logo: <img src={grs} alt="Global Recycled Standard" className="w-24 h-24 object-cover" />, name: 'GRS', description: 'Global Recycled Standard' },
  {
    id: 'oeko-tex',
    logo: (
      <div className="w-24 h-24 border border-[#EBE4DC] flex flex-col items-center justify-center gap-1 px-1 bg-white">
  ...
  { id: 'nongmo', logo: <img src={nongmo} alt="NON-GMO" className="w-20 h-20 object-contain" />, name: 'NON-GMO', description: 'Verified' },
];
  ...
  return (
    <section className="bg-white border-t border-[#EBE4DC] py-10">
      <div className="w-full px-6 sm:px-[80px] grid grid-cols-1 lg:grid-cols-[0.7fr_2fr] gap-8 items-center">
        ...
        {/* Right Logos */}
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-6 justify-items-center divide-x-0 lg:divide-x divide-[#EBE4DC]">
          {certs.map((c) => (
